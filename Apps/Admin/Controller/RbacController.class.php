...
class Rbaccontroller extends AdminBaseController {
    ...
    **/
    public function user_listAction() {
        $this->user =  D('ThinkUserRelation')->field('password', true)->relation(true)->select();
        $this->display();
    }
    ...
    **/
    public function node_listAction() {
        ...
        $node = M('ThinkNode')->field($field)->order('sort asc')->select();
    ...
    **/
    ...
    public function accessAction() {
        ...
        $field = array('id', 'name', 'title', 'pid');
        $node = M('ThinkNode')->field($field)->order('sort asc')->select();
        $access = M('ThinkAccess')->where('role_id = '.$rid)->getField('node_id', true);//已经拥有的权限
